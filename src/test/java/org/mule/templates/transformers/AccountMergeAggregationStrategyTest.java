...
public class AccountMergeAggregationStrategyTest extends AbstractTemplateTestCase {
	...
	public void testAggregate() throws Exception {
		List<Map<String, String>> accountsA = AccountsMergeTest.prepareAccountsA();
		List<Map<String, String>> accountsB = AccountsMergeTest.prepareAccountsB();
		...
		AccountMergeAggregationStrategy sfdcMerge = new AccountMergeAggregationStrategy();
